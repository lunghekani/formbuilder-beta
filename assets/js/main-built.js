...
function () {
    ...
    function () {
        ...
        return '<h3>Rendered source of your form:</h3>\n<form action="form-writer.php" method="post"><textarea id="render" name="getrender" method="post" class="span6"></textarea> <input type="submit" value="submit" name="igo" placeholder="iSubmit"> <button name="go" type="Submit" Placeholder="submit">Submit</button></form>\n'
